...
/**
 * Get module assets dynamically based on enabled modules
 * This function reads the modules_statuses.json file to determine which modules are enabled
 * and automatically includes their JS/CSS/SCSS assets in the build process.
 * This ensures that when new modules are added and enabled, their assets are automatically
 * included without manual configuration changes.
 * @returns array
 */
