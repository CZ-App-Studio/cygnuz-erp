...
$(document).ready(function() {
  ...
  function exportToExcel() {
    ...
    Swal.fire({
      ...
      text: 'Report exported as Excel successfully.',
      customClass: {
        confirmButton: 'btn btn-success'
      },
      buttonsStyling: false
  ...
  function exportToPDF() {
    // This would typically use a library like jsPDF or make an AJAX call to generate PDF server-side
    Swal.fire({
      icon: 'info',
      title: 'PDF Export',
      text: 'PDF export functionality will be implemented with server-side generation.',
      customClass: {
        confirmButton: 'btn btn-primary'
      },
      buttonsStyling: false
