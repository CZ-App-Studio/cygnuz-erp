...
use Modules\WMSInventoryCore\app\Http\Controllers\WMSInventoryCoreController;
...
use Modules\WMSInventoryCore\app\Http\Controllers\InventoryCountController;
...
Route::middleware(['auth', 'verified'])->prefix('inventory')->name('wmsinventorycore.')->group(function () {
  ...
  Route::get('/test-route-loading', function() { return 'Routes are loading'; })->name('test.loading');
