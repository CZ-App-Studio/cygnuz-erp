...
use Modules\HRCore\app\Settings\HRCoreSettings;
...
class HRCoreServiceProvider extends ServiceProvider
{
  ...
  protected string $nameLower = 'hrcore';
  ...
  protected function registerModuleSettings(): void
  {
    if ($this->app->bound(SettingsRegistry::class)) {
      ...
      $registry->registerModule('hrcore', [
        'name' => __('HR Management'),
        'description' => __('Configure employee lifecycle, leave policies, and organizational structure settings'),
        'icon' => 'bx bx-group',
        'handler' => HRCoreSettings::class,
